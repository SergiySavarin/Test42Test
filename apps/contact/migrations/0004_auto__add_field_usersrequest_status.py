...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UsersRequest.status'
        db.add_column(u'contact_usersrequest', 'status',
                      self.gf('django.db.models.fields.CharField')(default=u'', max_length=256),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UsersRequest.status'
        db.delete_column(u'contact_usersrequest', 'status')
    ...
    models = {
        ...
        u'contact.usersrequest': {
            ...
            'status': ('django.db.models.fields.CharField', [], {'default': "u''", 'max_length': '256'})
        }
    }
